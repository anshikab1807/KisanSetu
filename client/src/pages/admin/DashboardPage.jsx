  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-green-100 to-green-200 px-4 py-8 relative overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-8 max-w-5xl mx-auto">
        <h1 className="text-3xl font-extrabold text-green-800">Manage Categories</h1>
        <button
          onClick={handleAddClick}
          className="flex items-center space-x-2 bg-yellow-400 text-green-800 font-bold px-4 py-2 rounded-lg shadow hover:bg-yellow-500 transition"
        >
          <FaPlus />
      ...
      {categories.length > 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-green-50">
                <tr>
                  <th className="text-left px-6 py-3 text-xs font-medium text-green-700 uppercase tracking-wider">
                    Category
                  </th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-green-700 uppercase tracking-wider">
                    Description
                  </th>
                  <th className="text-right px-6 py-3 text-xs font-medium text-green-700 uppercase tracking-wider">
                    Actions
                  </th>
                </tr>
              </thead>
        ...
        <div className="text-center py-12 glass rounded-xl bg-white/80 shadow-lg max-w-md mx-auto">
          <FaLeaf className="text-green-500 text-5xl mx-auto mb-4" />
          <h3 className="text-xl font-semibold text-green-800 mb-2">No Categories Found</h3>
          <p className="text-green-700 mb-6">Add your first category to get started.</p>
          <button
            onClick={handleAddClick}
            className="bg-yellow-400 text-green-800 font-bold px-4 py-2 rounded-lg shadow hover:bg-yellow-500 transition"
          >
            Add Category
          </button>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="form-input w-full border border-green-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-yellow-400"
                  required
                />
              </div>
              <div className="mb-4">
              ...
              <div className="mb-6">
                <label htmlFor="icon" className="block text-sm font-medium text-green-700 mb-1">
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-yellow-400 text-green-800 rounded-lg hover:bg-yellow-500 transition font-bold"
                >
